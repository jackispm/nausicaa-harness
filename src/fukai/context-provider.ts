...
const SKILL_CATALOG_PREAMBLE = "Available Skills (metadata only). When a request matches a listed Skill, call `skill` with its exact name to load the instructions.";
