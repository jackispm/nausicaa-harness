...
export const PUBLIC_INTERACTIVE_COMMANDS: readonly InteractiveCommandSpec[] = Object.freeze([
  ...
  command({
    name: "reload",
    description: "Reload Skills, MCP discovery, model catalog, and keyboard shortcuts",
    references: ["prime", "pi"],
    alignment: "shared",
    visibility: "public",
  }),
  ...
  command({
    name: "update",
    description: "Update Nausicaa to the latest release",
    references: ["prime"],
    alignment: "semantic-review",
    visibility: "public",
  }),
  command({
    name: "login",
    description: "Connect a model provider with an API key or account",
  ...
  command({
    name: "skills",
    description: "Browse Skills and insert a /skill:name invocation",
  ...
  command({
    ...
    argumentHint: "[search|provider:model]",
    references: ["prime", "codex", "pi"],
    alignment: "shared",
    visibility: "public",
  }),
  ...
  command({
    name: "export",
    description: "Export the current session as HTML or portable JSONL",
  ...
  command({
    name: "import",
    description: "Import a portable JSONL session as a new session",
